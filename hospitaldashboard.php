...
<html lang="en">
    ...
    <body>
        ...
        <nav class="navbar navbar-expand-sm bg-dark navbar-dark">
            ...
            <div class="container-fluid border"><h4>
            <?php echo $row['name']; ?> 's Dashboard</h4>
            </div>
            ...
            <table class="table table-dark table-striped">
                <thead class="thead-inverse">
                    ...
                    <tbody>
                        ...
                        ?>
                        <tr>
                        <td><a href="patientupdate.php?patientid=<?php echo $row['id'] ?>" class="btn btn-info" role="button">Update Info</a></td>
