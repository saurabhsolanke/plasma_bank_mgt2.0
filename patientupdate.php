          ...
          <form action="patientupdate.php" method="post">
            ...
            <!-- 
              ...
              <div class="form-group row">
                ...
                <div class="col-md-6">
                <input type="text" class="form-control" name="blood_group" value="<?php echo $patient['blood_group']; ?>" placeholder="Enter blood group">
              </div>   
              </div>
              ...
              <div class="form-group row">
                ...
                <div class="col-md-6">
                <input type="text" class="form-control" name="aadhar" value="<?php echo $patient['aadhar']; ?>" placeholder="Enter aadhar card">
              </div>
              </div>
              ...
              <div class="form-group row">
                ...
                <div class="col-md-6">
                <input type="date" class="form-control" name="plasma_donated" value="<?php echo $patient['plasma_donated']; ?>" placeholder="Enter date">
              </div>
              </div>
