            ...
            if ($repassword!= $password) {
                ...
                if ($name == "") {
                    ...
                    if ($email == "") {
                        ...
                        include "conn.php";
                        $regQuery = "INSERT INTO users (name , email ,type, gender, age, blood_group, address , phone , aadhar , covid_report , recovered_on , plasma_donated,pid)
                         VALUES (' $name', '$email','donor', '$gender', '$age', '$blood_group', '$address' , '$phone', '$aadhar', '$covid_report', '$recovered_on', '$plasma_donated', '$pid')";
    ...
    <div class="container mt-5 p-5 my-5 border">
      ...
      <div class="card-header"><b>Register</b></div>
          ...
          <form action="donor.php" method="post">
              ...
              <button type="cancel" name="plasmabankLogin" value="cancel" class="btn btn-danger">cancel</button>
          </form>
